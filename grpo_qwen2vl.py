...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def _get_per_token_logps(self, model, input_ids, attention_mask, pixel_values, image_grid_thw, logits_to_keep):
        ...
        logits = model(
            input_ids=input_ids, attention_mask=attention_mask, pixel_values=pixel_values, image_grid_thw=image_grid_thw
        ).logits
    ...
    def _generate_and_score_completions(
        ...
        # Repeat image inputs to match batch size after generation
